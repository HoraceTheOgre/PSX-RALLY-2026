...
#   GravelSurface.gd  →  assign to @export var gravel_surface
#   TarmacSurface.gd  →  assign to @export var tarmac_surface
#   GrassSurface.gd   →  assign to @export var grass_surface
#
